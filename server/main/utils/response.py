...
__all__ = ['correct_response', 'err_response_with_desc', 'err_response', 'err_response_miss_param', 'err_response_not_belong',
           'err_response_permission', 'err_response_pk', 'err_response_token', 'err_response_user_lock', 'err_response_value_err']
...
def err_response_with_desc(description):
    """发生错误时的返回

    :param description: 错误描述

    """
    params = {"code": 1, "msg": description}
